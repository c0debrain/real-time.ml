...
var AppComponent = /** @class */ (function () {
    function AppComponent(marketStatusSvc, tweetsCountsSvc, tweetTextSvc) {
        var _this = this;
        ...
        this.marketStatusSvc.getInitialMarketStatus()
            ...
            _this.MarketStatus = prices;
            var marketUpdateObservable = _this.marketStatusSvc.getUpdates();
            marketUpdateObservable.subscribe(function (latestStatus) {
                _this.MarketStatus = [latestStatus].concat(_this.marketStatus);
            });
        });
        this.tweetsCountsSvc.getInitialTweetCountBiden()
            .subscribe(function (tweet_count) {
            _this.BidenTweetCount = tweet_count;
            var tweetUpdatesObservable = _this.tweetsCountsSvc.getBidenUpdates();
            tweetUpdatesObservable.subscribe(function (latestCount) {
                _this.BidenTweetCount = [latestCount].concat(_this.bidenTweetCount);
            });
        });
        this.tweetsCountsSvc.getInitialTweetCountTrump()
            .subscribe(function (tweet_count) {
            _this.TrumpTweetCount = tweet_count;
            var tweetUpdatesObservable = _this.tweetsCountsSvc.getTrumpUpdates();
            tweetUpdatesObservable.subscribe(function (latestCount) {
                _this.TrumpTweetCount = [latestCount].concat(_this.trumpTweetCount);
            });
        });
        this.tweetTextSvc.getInitialTweetTextStatus()
            .subscribe(function (tweets) {
            _this.TweetStatus = new _tweet_text__WEBPACK_IMPORTED_MODULE_5__["TweetText"](tweets);
            var tweetStatusObservable = _this.tweetTextSvc.getUpdates();
            tweetStatusObservable.subscribe(function (latestStatus) {
                _this.TweetStatus = latestStatus;
            });
        });
    }
    Object.defineProperty(AppComponent.prototype, "MarketStatus", {
        set: function (status) {
    ...
    Object.defineProperty(AppComponent.prototype, "BidenTweetCount", {
        set: function (tweetCount) {
    ...
    Object.defineProperty(AppComponent.prototype, "TrumpTweetCount", {
        set: function (tweetCount) {
    ...
    Object.defineProperty(AppComponent.prototype, "TweetStatus", {
        set: function (status) {
...
var MarketStatusService = /** @class */ (function () {
    function MarketStatusService(httpClient) {
        this.httpClient = httpClient;
        this.baseUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_base_url;
    }
    MarketStatusService.prototype.getInitialMarketStatus = function () {
        return this.httpClient.get(this.baseUrl + "/api/v1/tweet_counts_all");
    };
    MarketStatusService.prototype.getUpdates = function () {
        var socket = socket_io_client__WEBPACK_IMPORTED_MODULE_5__(this.baseUrl);
        var marketSub = new rxjs__WEBPACK_IMPORTED_MODULE_4__["Subject"]();
        var marketSubObservable = Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["from"])(marketSub);
        socket.on('tweet_counts_all', function (marketStatus) {
            marketSub.next(marketStatus);
        });
        return marketSubObservable;
    };
    MarketStatusService.ctorParameters = function () { return [
...
var TweetCountsService = /** @class */ (function () {
    function TweetCountsService(httpClient) {
        this.httpClient = httpClient;
        this.baseUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_base_url;
    }
    TweetCountsService.prototype.getInitialTweetCountBiden = function () {
        return this.httpClient.get(this.baseUrl + "/api/v1/tweet_counts_biden");
    };
    TweetCountsService.prototype.getInitialTweetCountTrump = function () {
        return this.httpClient.get(this.baseUrl + "/api/v1/tweet_counts_trump");
    };
    TweetCountsService.prototype.getTrumpUpdates = function () {
        var socket = socket_io_client__WEBPACK_IMPORTED_MODULE_5__(this.baseUrl);
        var trumpSub = new rxjs__WEBPACK_IMPORTED_MODULE_4__["Subject"]();
        var trumpSubObservable = Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["from"])(trumpSub);
        socket.on('tweet_counts_trump', function (trumpStatus) {
            trumpSub.next(trumpStatus);
        });
        return trumpSubObservable;
    };
    TweetCountsService.prototype.getBidenUpdates = function () {
        var socket = socket_io_client__WEBPACK_IMPORTED_MODULE_5__(this.baseUrl);
        var marketSub = new rxjs__WEBPACK_IMPORTED_MODULE_4__["Subject"]();
        var marketSubObservable = Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["from"])(marketSub);
        socket.on('tweet_counts_biden', function (marketStatus) {
            marketSub.next(marketStatus);
        });
        return marketSubObservable;
    };
    TweetCountsService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
...
var TweetEmbedComponent = /** @class */ (function () {
    function TweetEmbedComponent() {
        this.first = 1;
        this.second = 2;
        this.third = 3;
    ...
    TweetEmbedComponent.prototype.ngOnInit = function () {
        this.pause = false;
        this.curr_twt = 0;
        this.test_tweets = [];
        for (var i = 0; i < 1; i++) {
    ...
    TweetEmbedComponent.prototype.ngOnChanges = function () {
    ...
    TweetEmbedComponent.prototype.ngAfterViewInit = function () {
        // @ts-ignore
        twttr.widgets.load();
    };
...
var TweetTextService = /** @class */ (function () {
    function TweetTextService(http) {
        this.http = http;
        this.baseUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_base_url;
    }
    TweetTextService.prototype.getInitialTweetTextStatus = function () {
        return this.http.get(this.baseUrl + "/api/v1/tweet_text_all");
    };
    TweetTextService.prototype.getUpdates = function () {
        var socket = socket_io_client__WEBPACK_IMPORTED_MODULE_6__(this.baseUrl);
        var tweettextSub = new rxjs__WEBPACK_IMPORTED_MODULE_5__["Subject"]();
        var tweettextSubObservable = Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["from"])(tweettextSub);
        socket.on('tweet_text_all', function (fullTweet) {
            var tweettextStatus = new _tweet_text__WEBPACK_IMPORTED_MODULE_4__["TweetText"](fullTweet);
            tweettextSub.next(tweettextStatus);
        });
        return tweettextSubObservable;
    };
    TweetTextService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
...
var TweetText = /** @class */ (function () {
    function TweetText(fullTweet) {
        var tweet = fullTweet['_source'];
    ...
    TweetText.ctorParameters = function () { return [
        { type: Object }
    ]; };
    return TweetText;
}());
...
var TweetsLineChartBidenComponent = /** @class */ (function () {
    function TweetsLineChartBidenComponent() {
        // options
    ...
    TweetsLineChartBidenComponent.prototype.ngOnChanges = function () {
        if (this.tweetCounts) { // Variable undefined on first ngOnChanges call
            this.updateChart();
        }
    };
    TweetsLineChartBidenComponent.prototype.updateChart = function () {
        var now = new Date(this.tweetCounts[0].date);
        ...
        this.multi = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.multi);
    };
    TweetsLineChartBidenComponent.prototype.onSelect = function (event) {
        //console.log(event);
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ...
    return TweetsLineChartBidenComponent;
}());
...
var TweetsLineChartTrumpComponent = /** @class */ (function () {
    function TweetsLineChartTrumpComponent() {
        // options
        this.animations = false;
        this.showXAxis = true;
        this.showYAxis = true;
    ...
    TweetsLineChartTrumpComponent.prototype.ngOnChanges = function () {
        if (this.tweetCounts) { // Variable undefined on first ngOnChanges call
            this.updateChart();
        }
    };
    TweetsLineChartTrumpComponent.prototype.updateChart = function () {
        var now = new Date(this.tweetCounts[0].date);
        this.multi[0].series.push({
            "name": now.getHours() + ":" + now.getMinutes() + ":" + now.getSeconds(),
            "value": this.tweetCounts[0].num_tweets
    ...
    TweetsLineChartTrumpComponent.prototype.onSelect = function (event) {
        //console.log(event);
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ...
    return TweetsLineChartTrumpComponent;
}());
...
var TweetsLineChartComponent = /** @class */ (function () {
    function TweetsLineChartComponent() {
        // options
        this.animations = false;
        this.showXAxis = true;
        this.showYAxis = true;
    ...
    TweetsLineChartComponent.prototype.ngOnChanges = function () {
        if (this.marketStatus) { // Variable undefined on first ngOnChanges call
            this.updateChart();
        }
    };
    TweetsLineChartComponent.prototype.updateChart = function () {
        var now = new Date(this.marketStatus[0].date);
    ...
    TweetsLineChartComponent.prototype.onSelect = function (event) {
        //console.log(event);
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ...
    return TweetsLineChartComponent;
}());
